...
export const ENERGY_LAYERS: EnergyLayer[] = [
  ...
  { id: 'layer.blaze', name: 'Blaze', kind: 'layer', style: 'blaze', attack: 72, mass: 0.40, color: 0xff5a36, blades: 5, cost: 220 },
  { id: 'layer.aegis', name: 'Aegis', kind: 'layer', style: 'aegis', attack: 44, mass: 0.62, color: 0x3f9bff, blades: 10, cost: 240 },
  { id: 'layer.glide', name: 'Glide', kind: 'layer', style: 'glide', attack: 38, mass: 0.30, color: 0x49e6a4, blades: 3, cost: 220 },
  { id: 'layer.storm', name: 'Storm', kind: 'layer', style: 'storm', attack: 88, mass: 0.50, color: 0xb05cff, blades: 6, cost: 520 },
  { id: 'layer.bastion', name: 'Bastion', kind: 'layer', style: 'bastion', attack: 41, mass: 0.82, color: 0x18c4c8, blades: 8, cost: 540 },
];
...
export const FORGE_DISCS: ForgeDisc[] = [
  ...
  { id: 'disc.light', name: 'Light', kind: 'disc', style: 'light', weight: 0.62, stability: 34, drainMul: 1.06, cost: 180 },
  { id: 'disc.heavy', name: 'Heavy', kind: 'disc', style: 'heavy', weight: 1.5, stability: 80, drainMul: 0.93, cost: 260 },
  { id: 'disc.wide', name: 'Wide Guard', kind: 'disc', style: 'wide', weight: 1.24, stability: 72, drainMul: 0.86, cost: 500 },
];
